package com.bezzangss.sign.application.documents.associate.cc.port.in.dto.request;
...
@Getter
public class CcApplicationCreateRequest {
    ...
    @Builder
    public CcApplicationCreateRequest(String name, String email, String cellPhone, String documentId) {
